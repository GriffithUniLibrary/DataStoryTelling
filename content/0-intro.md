...
{% include figure.html img="Gapminder_GDPCapita.png" alt="cat" caption="Income per person (GDP/capita, yearly growth) from https://www.gapminder.org/data/, free to use, CC-BY LICENSE" width="80%" %}
