...
{% include figure.html img="Storyboard_template_example.svg.png" alt="Storyboarding and storymapping" caption="Storyboard template example by Whisternefet, CC BY-SA 3.0 <https://commons.wikimedia.org/wiki/File:Storyboard_template_example.svg>" width="80%" %}
